...
#define NUCLEI_TIMER_FREQ		5000000/*32768 ian fang*/

/* Nuclei timer base address */
#define NUCLEI_NUCLEI_TIMER_ADDR  0x68020000	/*0x2000000 ian fang*/
...
#define NUCLEI_PLIC_ADDR	0x64000000    /*	0x8000000*/
...
/* clang-format on */
static u32 nuclei_clk_freq = 50000000 ; /*16000000; ian fang */
...
static int nuclei_early_init(bool cold_boot)
{
 ...
 /* SysTimer_clk_sel();*/
  ...
  __RV_CSR_CLEAR(0x7D0,(1<<3));
	...
	nuclei_clk_freq =nuclei_get_clk_freq();//50000000
       /* sbi_printf("nuclei_clk_freq=%d \n", nuclei_clk_freq);*/
  /*uart initial*/
 /* __RV_CSR_CLEAR(0x7D0,(1<<3));*/
...
static int nuclei_final_init(bool cold_boot)
{
	...
	sbi_printf("modify dt before 1  %p, nuclei_clk_freq %d\n",(unsigned long *)fdt, nuclei_clk_freq);
